...
def next_card():
    ...
    canvas.itemconfig(card_background, image=cart_front_img)
...
card_background = canvas.create_image(400, 263, image=cart_front_img)
...
known_button = Button(image=check_images, highlightthickness=0, command=next_card)
